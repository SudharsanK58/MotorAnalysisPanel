            ...
            <Row className="g-gs justify-content-center">
              ...
              <Col sm="3">
                <div className="form-group">
                  <Label>Client</Label>
                  <div className="form-control-wrap">
                    <select {...register("clientId")} className="form-control" onChange={(e) => setSelectedClient(e.target.value)}>
                  ...
                  {errors.clientId && <span className="error-message">{errors.clientId.message}</span>}
                  {warning && !selectedClient && <span className="error-message" style={{ color: 'red', fontWeight: 'bold' }}>Please select a client</span>}
                </div>
              </Col>
